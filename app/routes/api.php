...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('upload_profile_image/{id}', [UserController::class, 'uploadProfileImage']);
    ...
    Route::post('select_party_leaders', [PredictionController::class, 'updatePartyLeaders']);
    //end
    ...
    Route::post('submit_electoral_college_prediction_ap', [PredictionController::class,'submitElectoralCollegePredictionApp']);
    //end
    ...
    Route::get("get_predict_party_candidate/{id}", [PredictionController::class, 'getPredictedPartyCandidate']);
