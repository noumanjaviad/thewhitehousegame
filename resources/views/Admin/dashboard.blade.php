                                            ...
                                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body my-auto">
                                                        <h4 class="font-weight-bolder mb-0">{{number_format($user)}}</h4>
                                                ...
                                                <div class="media">
                                                    <div class="avatar bg-light-primary mr-2">
                                                        <div class="avatar-content">
                                                            ...
                                                            <img src="{{asset('/assets/image/candidates-icon.png')}}"  alt="Menu Icon" style="width: 20px; height: 20px;">
                                                        </div>
                                                    </div>
                                                    <div class="media-body my-auto">
                                                        <h4 class="font-weight-bolder mb-0">{{number_format($candidate)}}</h4>
                                                        <p class="card-text font-small-3 mb-0">Total Candidate</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                                <div class="media">
                                                    <div class="avatar bg-light-info mr-2">
                                                        <div class="avatar-content">
                                                            ...
                                                            <img src="{{asset('/assets/image/voter-party.png')}}"  alt="Menu Icon" style="width: 20px; height: 20px;">
                                                        </div>
                                                    </div>
                                                    <div class="media-body my-auto">
                                                        <h4 class="font-weight-bolder mb-0">{{number_format($party)}}</h4>
                                                        <p class="card-text font-small-3 mb-0">Total Party</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
